...
public class ConvexHull {
	/*
	 * Graham算法
	 * 1.先找出坐标中纵坐标最小的点(a,b) 设置为原点(0,0) 然后其他所有点都进行平移 e.g. (x-a,y-b) 
	 * 2.将所有坐标按照斜率大小排序 集合中第一位c1和第二位c2即为凸包上的点 
	 * 3.for i=0 i+2<集合size 把c(i) c(i+1) c(i+2)放入result中 然后判断c(i)c(i+1)所形成的直线的斜率与c(i+1)c(i+2)所形成的斜率的大小 
	 * 4.如果后者斜率大于前者斜率 回到第三步
	 * 5.如果后者斜率小于前者斜率 移除result中最后一位即c(i+2) 回到第三步
	 * */
